...
function main(config) {
  ...
  config['rules'] = [
    ...
    'DOMAIN-KEYWORD,xget.xi-xu,DIRECT',
    ...
    'DOMAIN-SUFFIX,hub.fastgit.org,DIRECT',
    'DOMAIN-SUFFIX,github.com.cnpmjs.org,DIRECT',
    'DOMAIN-SUFFIX,moeyy.cn,DIRECT',
    'DOMAIN-SUFFIX,ghproxy.link,DIRECT',
    'DOMAIN-SUFFIX,gitmirror.com,DIRECT',
    'DOMAIN-SUFFIX,doubao.com,DIRECT',
    'DOMAIN-SUFFIX,gh.api.99988866.xyz,DIRECT',
    // —— AI / 开发者相关 ——
    'DOMAIN-KEYWORD,github.dev,' + forOpenai,
